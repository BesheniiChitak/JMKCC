...
val variableARG=typeCheck<JVariable>(variable)
...
val indexVariableARG=typeCheck<JVariable>(indexVariable)
val valueVariableARG=typeCheck<JVariable>(valueVariable)
val listARG=typeCheck<JArray>(list)
...
val keyVariableARG=typeCheck<JVariable>(keyVariable)
val valueVariableARG=typeCheck<JVariable>(valueVariable)
val mapARG=typeCheck<JMap>(map)
...
val mapARG=typeCheck<JVariable>(map)
...
val xARG=typeCheck<JVariable>(x)
val yARG=typeCheck<JVariable>(y)
val zARG=typeCheck<JVariable>(z)
val yawARG=typeCheck<JVariable>(yaw)
val pitchARG=typeCheck<JVariable>(pitch)
val locationARG=typeCheck<JLocation>(location)
...
val variableForHitLocationARG=typeCheck<JVariable>(variableForHitLocation)
val variableForHitBlockLocationARG=typeCheck<JVariable>(variableForHitBlockLocation)
val variableForHitBlockFaceARG=typeCheck<JVariable>(variableForHitBlockFace)
val variableForHitEntityUuidARG=typeCheck<JVariable>(variableForHitEntityUuid)
val startARG=typeCheck<JLocation>(start)
val raySizeARG=numberConvert(funName,"raySize",raySize)
val maxDistanceARG=numberConvert(funName,"maxDistance",maxDistance)
...
val removedValueARG=typeCheck<JVariable>(removedValue)
val variableARG=typeCheck<JVariable>(variable)
val listARG=typeCheck<JArray>(list)
val indexARG=numberConvert(funName,"index",index)
